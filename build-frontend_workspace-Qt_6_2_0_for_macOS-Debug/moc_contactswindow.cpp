...
#include <memory>
#include "../frontend_workspace/contactswindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ContactsWindow_t, stringdata0) + ofs), len 
...
const QMetaObject ContactsWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_ContactsWindow.offsetsAndSize,
    qt_meta_data_ContactsWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ContactsWindow_t
