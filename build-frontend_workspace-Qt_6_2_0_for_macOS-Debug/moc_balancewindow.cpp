...
#include <memory>
#include "../frontend_workspace/balancewindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_BalanceWindow_t, stringdata0) + ofs), len 
...
const QMetaObject BalanceWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_BalanceWindow.offsetsAndSize,
    qt_meta_data_BalanceWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_BalanceWindow_t
