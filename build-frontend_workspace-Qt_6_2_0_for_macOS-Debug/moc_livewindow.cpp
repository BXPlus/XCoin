...
#include <memory>
#include "../frontend_workspace/livewindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LiveWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_LiveWindow_t qt_meta_stringdata_LiveWindow = {
    {
QT_MOC_LITERAL(0, 10) // "LiveWindow"
...
const QMetaObject LiveWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_LiveWindow.offsetsAndSize,
    qt_meta_data_LiveWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LiveWindow_t
, QtPrivate::TypeAndForceComplete<LiveWindow, std::true_type>
