...
public:
    ...
    bool validateTxIn(Transaction transaction, std::vector<UnspentTxOut> aUnspentTxOuts);
};
...
UnspentTxOut findUnspentTxOut(std::string transactionId, int index, std::vector<UnspentTxOut> aUnspentTxOuts);
