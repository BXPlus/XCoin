...
#include "src/XNode/blockchain.pb.h"
...
const char descriptor_table_protodef_src_2fXNode_2fblockchain_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "blicKey\030\002 \001(\t\"<\n\014DNSHandshake\022,\n\007entries"
  "\030\001 \003(\0132\033.xcoin.interchange.DNSEntryb\006pro"
  "to3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_src_2fXNode_2fblockchain_2eproto = {
  false, false, 1083, descriptor_table_protodef_src_2fXNode_2fblockchain_2eproto, "src/XNode/blockchain.proto", 
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      // repeated .xcoin.interchange.DNSEntry entries = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr -= 1;
          do {
