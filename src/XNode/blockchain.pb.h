...
class PingPong final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:xcoin.interchange.PingPong) */ {
 public:
  ...
  inline PingPong* New() const final {
    return new PingPong();
  }

  PingPong* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(PingPong* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "xcoin.interchange.PingPong";
  }
  protected:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_lasthash();
  ...
  // @@protoc_insertion_point(class_scope:xcoin.interchange.PingPong)
 private:
  class _Internal;
...
// uint32 height = 1;
inline void PingPong::clear_height() {
  height_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 PingPong::_internal_height() const {
  return height_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 PingPong::height() const {
  // @@protoc_insertion_point(field_get:xcoin.interchange.PingPong.height)
  return _internal_height();
}
inline void PingPong::_internal_set_height(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  height_ = value;
}
inline void PingPong::set_height(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_height(value);
  // @@protoc_insertion_point(field_set:xcoin.interchange.PingPong.height)
}

// string lastHash = 2;
inline void PingPong::clear_lasthash() {
  lasthash_.ClearToEmpty();
}
inline const std::string& PingPong::lasthash() const {
  // @@protoc_insertion_point(field_get:xcoin.interchange.PingPong.lastHash)
  return _internal_lasthash();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PingPong::set_lasthash(ArgT0&& arg0, ArgT... args) {
 
 lasthash_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:xcoin.interchange.PingPong.lastHash)
}
inline std::string* PingPong::mutable_lasthash() {
  std::string* _s = _internal_mutable_lasthash();
  // @@protoc_insertion_point(field_mutable:xcoin.interchange.PingPong.lastHash)
  return _s;
}
inline const std::string& PingPong::_internal_lasthash() const {
  return lasthash_.Get();
}
inline void PingPong::_internal_set_lasthash(const std::string& value) {
  
  lasthash_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* PingPong::_internal_mutable_lasthash() {
  
  return lasthash_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* PingPong::release_lasthash() {
  // @@protoc_insertion_point(field_release:xcoin.interchange.PingPong.lastHash)
  return lasthash_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void PingPong::set_allocated_lasthash(std::string* lasthash) {
  if (lasthash != nullptr) {
    
  } else {
    
  }
  lasthash_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), lasthash,
      GetArenaForAllocation());
