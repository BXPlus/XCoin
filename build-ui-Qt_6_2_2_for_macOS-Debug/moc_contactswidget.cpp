...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ContactsWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ContactsWidget_t qt_meta_stringdata_ContactsWidget = {
    {
QT_MOC_LITERAL(0, 14) // "ContactsWidget"
...
const QMetaObject ContactsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ContactsWidget.offsetsAndSize,
    qt_meta_data_ContactsWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ContactsWidget_t
